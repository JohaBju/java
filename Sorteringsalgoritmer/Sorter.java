//https://github.uio.no/IN2010/oblig3_h20_src/blob/master/Sorter.java
...
abstract class Sorter {
    ...
    // Set true when a sort exceeds MainRunner.TIME_LIMIT_MS
    ...
    String run() {
        ...
        if (timems > MainRunner.TIME_LIMIT_MS) {
            discard = true;
