...
class Graph {
	...
	Graph(int v, int e, boolean maximum)
	{
		V = v;
		E = e;
		isMaximum = maximum;
	...
	void KruskalMST()
	{
		...
		// the built MST
		System.out.println("Constructing " + (isMaximum ? "Maximum" : "Minimum") + " Spanning Tree using Kruskal's Algorithm.");
		int minimumCost = 0;
		for (i = 0; i < e; ++i)
		{
		...
		System.out.println((isMaximum ? "Maximum" : "Minimum") + " Cost Spanning Tree has cost "
						+ minimumCost);
	}
	...
	public static void main(String[] args)
	{
		...
		Graph graph = new Graph(V, E, false);
