//https://github.uio.no/IN2010/oblig3_h20_src/blob/master/Oblig3Runner.java
...
class MainRunner {
    ...
    static final Sorter[] ALGS1 = { new InsertionSort(), new Quicksort(), new Merge(), new Bubble(), new Bogo()};
    // Put the sorting algorithms under test for part 2 here
    static final Sorter[] ALGS2 = { new InsertionSort(), new Quicksort(), new Merge(), new Bubble(), new Bogo()  };
    // Time limit for a single sorting in milliseconds
    static final long TIME_LIMIT_MS = 10000;
